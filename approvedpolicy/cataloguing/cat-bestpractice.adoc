Series Cataloguing
~~~~~~~~~~~~~~~~~~
Sitka libraries use the current Library of Congress standard when cataloguing series. The standard is that the 490 tag is used for a series statement for a series title. If an added entry is required, you must use the 800 or 830 tag. The 440 tag has been obsolete since 2008, and while records containing 440 tags are still in the shared catalogue, new series statements must follow the current standard.
