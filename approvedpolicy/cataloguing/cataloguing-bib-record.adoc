...
|https://www.loc.gov/marc/bibliographic/bd59x.html[590]|Local Notes|5|No|Used for any local notes that do not fit into another field.
...
|https://www.loc.gov/marc/bibliographic/bd69x.html[690]|Local Subject Access Fields|5|Yes|Used for local subject headings (ie. not Library of Congress or Canadian Subject Headings).
