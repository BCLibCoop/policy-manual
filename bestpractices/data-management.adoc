...
Regularly running a report on your current collection ADD LINK enables you to see at a glance where data issues may lie. With this report you're able to see at a glance if you have items without circulation modifiers and if you have items with circulation
...
* Circ Modifier: Copies with Selected Circ Modifiers ADD LINK
* Items Without Circulation Modifiers ADD LINK
* Shelving Location: Items with Selected Shelving Location ADD LINK
* Shelving Location and Circ Modifier: Items with Selected Shelving Location and Circ Modifier ADD LINK
