...
Regularly running a report on your https://docs.libraries.coop/sitka/_collection_management.html#_title_amp_item_count_by_shelving_location_and_circulation_modifier[current collection] enables you to see at a glance where data issues may lie. With this report you're able to see at a glance if you have items without circulation modifiers and if you have items with circulation
...
* https://docs.libraries.coop/sitka/_collection_management.html#_shelving_location_and_circ_modifier_items_with_selected_shelving_location_and_circ_modifier[Shelving Location and Circ Modifier: Items with Selected Shelving Location and Circ Modifier]
