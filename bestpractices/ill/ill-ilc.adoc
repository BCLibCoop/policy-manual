...
Interlibrary Loan Closures
^^^^^^^^^^^^^^^^^^^^^^^^^^

Libraries may have times when interlibrary loans will not be processed at their library due to staff holidays, 
closures for renovations, etc. 

Co-op Support will close Interlibrary Connect in Evergreen for extended closures. (An extended closure is a 
closure that last at least two weeks.)  To request an extended closure of ILC please send a ticket to Support
with the dates of your closure.
